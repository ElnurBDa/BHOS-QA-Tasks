var gatling = (() => {
  ...
  var require_final = __commonJS({
    "node_modules/@gatling.io/core/target/checks/final.js"(exports) {
      ...
      var wrapCheckBuilderFinal = (_underlying) => ({
        ...
        name: (n2) => (0, exports.wrapCheckBuilderFinal)(_underlying.name(n2)),
  ...
  var require_feeders = __commonJS({
    "node_modules/@gatling.io/core/target/feeders.js"(exports) {
      ...
      var arrayFeeder2 = (data) => wrapFeederBuilder(jvm_types_1.CoreDsl.arrayFeeder(data));
      exports.arrayFeeder = arrayFeeder2;
    }
  });
  ...
  __export(stdin_exports, {
    registeruser: () => registeruser_gatling_default
  });

  // src/registeruser.gatling.js
  var import_core = __toESM(require_target());
  var import_http = __toESM(require_target2());
  var options = [
    { filename: "mock/mock_data_1000.csv", number: 1e3 },
    { filename: "mock/mock_data_10000.csv", number: 1e4 },
    { filename: "mock/mock_data_100000.csv", number: 1e5 }
  ];
  var n = 0;
  var registeruser_gatling_default = (0, import_core.simulation)((setUp) => {
    const feeder = (0, import_core.csv)(options[n].filename).random();
    const users = (0, import_core.scenario)("Users").feed(feeder).exec(
      (0, import_http.http)("Register User").post("/register").body((0, import_core.StringBody)('{"email": "#{email}", "password": "#{password}"}')).asJson().check((0, import_http.status)().is(201))
    );
    ...
    setUp(users.injectOpen((0, import_core.rampUsers)(options[n].number).during(1))).protocols(
      httpProtocol
    );
  });

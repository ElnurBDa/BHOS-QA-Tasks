var gatling = (() => {
  ...
  var require_body = __commonJS({
    "node_modules/@gatling.io/core/target/body.js"(exports) {
      ...
      var StringBody4 = (string) => wrapBodyWithString(typeof string === "function" ? jvm_types_1.CoreDsl.StringBody((0, session_1.underlyingSessionTo)(string)) : jvm_types_1.CoreDsl.StringBody(string));
      exports.StringBody = StringBody4;
  ...
  var require_feeders = __commonJS({
    "node_modules/@gatling.io/core/target/feeders.js"(exports) {
      ...
      var csv4 = (filePath, quoteChar) => wrapBatchableFeederBuilder(quoteChar !== void 0 ? jvm_types_1.CoreDsl.csv(filePath, quoteChar) : jvm_types_1.CoreDsl.csv(filePath));
      exports.csv = csv4;
  ...
  var require_openInjection = __commonJS({
    "node_modules/@gatling.io/core/target/openInjection.js"(exports) {
      ...
      var rampUsers4 = (users) => wrapOpenInjectionStepRamp(jvm_types_1.CoreDsl.rampUsers(users));
      exports.rampUsers = rampUsers4;
  ...
  var require_checks2 = __commonJS({
    "node_modules/@gatling.io/http/target/checks.js"(exports) {
      ...
      var status4 = () => (0, core_1.wrapCheckBuilderFind)(jvm_types_1.HttpDsl.status());
      exports.status = status4;
    }
  });
  ...
  __export(stdin_exports, {
    post: () => post_gatling_default,
    postandref: () => postandref_gatling_default,
    postwithref: () => postwithref_gatling_default
  });

  // src/post.gatling.js
  var import_core = __toESM(require_target());
  var import_http = __toESM(require_target2());
  var filename = "mock/mock_data_post.csv";
  var post_gatling_default = (0, import_core.simulation)((setUp) => {
    const feeder = (0, import_core.csv)(filename).random();
    const users = (0, import_core.scenario)("Users").feed(feeder).exec(
      (0, import_http.http)("Add Post").post("/post").body((0, import_core.StringBody)('{"title": "#{title}", "content": "#{content}"}')).asJson().check((0, import_http.status)().is(201))
    );
    const httpProtocol = import_http.http.baseUrl("http://localhost:3000").acceptHeader("application/json").acceptLanguageHeader("en-US,en;q=0.5").acceptEncodingHeader("gzip, deflate").userAgentHeader(
      "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:109.0) Gecko/20100101 Firefox/119.0"
    );
    setUp(users.injectOpen((0, import_core.rampUsers)(1e4).during(1))).protocols(httpProtocol);
  });

  // src/postandref.gatling.js
  var import_core2 = __toESM(require_target());
  var import_http2 = __toESM(require_target2());
  var filename2 = "mock/mock_data_postandref.csv";
  var postandref_gatling_default = (0, import_core2.simulation)((setUp) => {
    const feeder = (0, import_core2.csv)(filename2).random();
    const users = (0, import_core2.scenario)("Users").feed(feeder).exec(
      (0, import_http2.http)("Add Post and Reference").post("/postandref").body((0, import_core2.StringBody)('{"title": "#{title}", "content": "#{content}", "referenceLinkURL": "#{referenceLinkURL}"}')).asJson().check((0, import_http2.status)().is(201))
    );
    const httpProtocol = import_http2.http.baseUrl("http://localhost:3000").acceptHeader("application/json").acceptLanguageHeader("en-US,en;q=0.5").acceptEncodingHeader("gzip, deflate").userAgentHeader(
      "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:109.0) Gecko/20100101 Firefox/119.0"
    );
    setUp(users.injectOpen((0, import_core2.rampUsers)(1e4).during(1))).protocols(httpProtocol);
  });

  // src/postwithref.gatling.js
  var import_core3 = __toESM(require_target());
  var import_http3 = __toESM(require_target2());
  var filename3 = "mock/mock_data_postwithref.csv";
  var postwithref_gatling_default = (0, import_core3.simulation)((setUp) => {
    const feeder = (0, import_core3.csv)(filename3).random();
    const users = (0, import_core3.scenario)("Users").feed(feeder).exec(
      (0, import_http3.http)("Add Post with Reference").post("/postwithref").body((0, import_core3.StringBody)('{"title": "#{title}", "content": "#{content}", "referenceLinkURL": "#{referenceLinkURL}"}')).asJson().check((0, import_http3.status)().is(201))
    );
    const httpProtocol = import_http3.http.baseUrl("http://localhost:3000").acceptHeader("application/json").acceptLanguageHeader("en-US,en;q=0.5").acceptEncodingHeader("gzip, deflate").userAgentHeader(
      "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:109.0) Gecko/20100101 Firefox/119.0"
    );
    setUp(users.injectOpen((0, import_core3.rampUsers)(1e4).during(1))).protocols(httpProtocol);
  });

var gatling = (() => {
  ...
  var require_body = __commonJS({
    "node_modules/@gatling.io/core/target/body.js"(exports) {
      ...
      var StringBody3 = (string) => wrapBodyWithString(typeof string === "function" ? jvm_types_1.CoreDsl.StringBody((0, session_1.underlyingSessionTo)(string)) : jvm_types_1.CoreDsl.StringBody(string));
      exports.StringBody = StringBody3;
  ...
  var require_feeders = __commonJS({
    "node_modules/@gatling.io/core/target/feeders.js"(exports) {
      ...
      var jsonFile3 = (filePath) => (0, exports.wrapFileBasedFeederBuilder)(jvm_types_1.CoreDsl.jsonFile(filePath));
      exports.jsonFile = jsonFile3;
  ...
  var require_checks2 = __commonJS({
    "node_modules/@gatling.io/http/target/checks.js"(exports) {
      ...
      var status3 = () => (0, core_1.wrapCheckBuilderFind)(jvm_types_1.HttpDsl.status());
      exports.status = status3;
    }
  });
  ...
  __export(stdin_exports, {
    updatebyid: () => updatebyid_gatling_default,
    updatebyname: () => updatebyname_gatling_default
  });

  // src/updatebyid.gatling.js
  var import_core = __toESM(require_target());
  var import_http = __toESM(require_target2());
  var filename = "data/mockData.json";
  var updatebyid_gatling_default = (0, import_core.simulation)((setUp) => {
    const feeder = (0, import_core.jsonFile)(filename).random();
    const users = (0, import_core.scenario)("Addresses").feed(feeder).exec(
      (0, import_http.http)("updateAddressByID").post("/address/updatebyname").body((0, import_core.StringBody)('{"id": "#{id}", "address": "#{address_line}"}')).asJson().check((0, import_http.status)().is(200))
    );
  ...
  // src/updatebyname.gatling.js
  var import_core2 = __toESM(require_target());
  var import_http2 = __toESM(require_target2());
  var filename2 = "data/mockData.json";
  var updatebyname_gatling_default = (0, import_core2.simulation)((setUp) => {
    const feeder = (0, import_core2.jsonFile)(filename2).random();
    const users = (0, import_core2.scenario)("Addresses").feed(feeder).exec(
      (0, import_http2.http)("updateAddressByName").post("/address/updatebyname").body((0, import_core2.StringBody)('{"name": "#{name}", "address": "#{address_line}"}')).asJson().check((0, import_http2.status)().is(200))
    );
